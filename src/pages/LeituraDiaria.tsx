...
export function LeituraDiariaPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4 animate-fade-in">
      ...
      {!isDriveConfigurado() && (
        <div className="flex items-start gap-3 bg-surface-50 dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-xl px-4 py-3">
          <AlertCircle size={16} className="text-surface-400 flex-shrink-0 mt-0.5" />
          <div className="text-xs text-surface-500 dark:text-surface-400">
            <span className="font-semibold text-surface-700 dark:text-surface-300">Google Drive não configurado.</span>{' '}
