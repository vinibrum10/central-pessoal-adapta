...
const ENGLISH_DRIVE_FOLDER_ID = import.meta.env.VITE_ENGLISH_DRIVE_FOLDER_ID as string | undefined;
...
export function getEnglishDriveConfigMessage(): string {
  return 'Google Drive de Inglês não configurado. Configure VITE_ENGLISH_DRIVE_FOLDER_ID para listar materiais.';
}
